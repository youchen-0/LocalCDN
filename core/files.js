...
var files = {
    ...
    [Environment.STABLE]: {
        ...
        'resources/angularjs/1.2.32/angular.min.jsm': true,
        'resources/angularjs/1.2.32/angular-animate.min.jsm': true,
        'resources/angularjs/1.2.32/angular-cookies.min.jsm': true,
        'resources/angularjs/1.2.32/angular-loader.min.jsm': true,
        'resources/angularjs/1.2.32/angular-resource.min.jsm': true,
        'resources/angularjs/1.2.32/angular-route.min.jsm': true,
        'resources/angularjs/1.2.32/angular-sanitize.min.jsm': true,
        'resources/angularjs/1.2.32/angular-touch.min.jsm': true,
